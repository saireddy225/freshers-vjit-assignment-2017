...
public class mmenu {
	...
	private void initialize() {
		...
		lblNewLabel.setBounds(380, 11, 552, 50);
		...
		lblVeg.setFont(new Font("Tahoma", Font.PLAIN, 30));
		lblVeg.setBounds(153, 122, 159, 37);
		frame.getContentPane().add(lblVeg);
		
		JLabel lblNonVeg = new JLabel("NON VEG");
		lblNonVeg.setFont(new Font("Tahoma", Font.PLAIN, 30));
		lblNonVeg.setBounds(636, 122, 159, 37);
		frame.getContentPane().add(lblNonVeg);
	}
