...
public class mngOrder {
	 ...
	 */
	public void moScreen() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					mngOrder window = new mngOrder();
	...
	private void initialize() {
		...
		lblNewLabel.setBounds(595, 13, 801, 59);
		...
		panel_4.setBounds(990, 145, 361, 462);
		...
		JLabel lblCustomerId = new JLabel("Table no");
